import Playlist from "../components/TheMain/Playlist/Playlist";
...
function TheMain({ toggleScrolling, showToast, showPopover }) {
  return (
      ...
      <div className="relative pt-[24px] pb-[48px] px-[32px] space-y-9  max-w-screen-5xl">
        ...
        <div>
          ...
          <div className="grid sm:grid-cols-playlists-mobile md:grid-cols-playlists-tablet lg:grid-cols-playlists-desktop gap-5">
            <a
              href="/"
              className="p-4 rounded-mb bg-[#181818] hover:bg-[#272727] duration-200 group relative"
            >
              ...
              <ul className="bg-[#282828] text-[#eaeaea] text-sm p-1 rounded shadow-x1 absolute top-9 left-9 cursor-default whitespace-nowrap divide-y divide-[#3e3e3e] hidden group-hover:block">
                ...
                <li className="relative">
                  <button className="w-full p-3 text-left hover:text-white hover:bg-[#3e3e3e] cursor-default flex justify-between">
                    Share
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
            ...
            <a
              href="/"
              className="sm:block hidden p-4 rounded-mb bg-[#181818] hover:bg-[#272727] duration-200 group relative"
            >
              <div className="relative">
                <img
                  className="rounded shadow-lg"
            ...
            <a
              href="/"
              className="lg:block hidden p-4 rounded-mb bg-[#181818] hover:bg-[#272727] duration-200 group relative"
            >
              <div className="relative">
                <img
                  className="rounded shadow-lg"
            ...
            <a
              href="/"
              className="xl:block hidden p-4 rounded-mb bg-[#181818] hover:bg-[#272727] duration-200 group relative"
            >
              <div className="relative">
                <img
                  className="rounded shadow-lg"
            ...
            <a
              href="/"
              className="2xl:block hidden p-4 rounded-mb bg-[#181818] hover:bg-[#272727] duration-200 group relative"
            >
              <div className="relative">
                <img
                  className="rounded shadow-lg"
            ...
            <a
              href="/"
              className="3xl:block hidden p-4 rounded-mb bg-[#181818] hover:bg-[#272727] duration-200 group relative"
            >
              <div className="relative">
                <img
                  className="rounded shadow-lg"
            ...
            <a
              href="/"
              className="4xl:block hidden p-4 rounded-mb bg-[#181818] hover:bg-[#272727] duration-200 group relative"
            >
              <div className="relative">
                <img
                  className="rounded shadow-lg"
            ...
            <a
              href="/"
              className="5xl:block hidden p-4 rounded-mb bg-[#181818] hover:bg-[#272727] duration-200 group relative"
            >
              <div className="relative">
                <img
                  className="rounded shadow-lg"
            ...
            <a
              href="/"
              className="6xl:block hidden p-4 rounded-mb bg-[#181818] hover:bg-[#272727] duration-200 group relative"
            >
              <div className="relative">
                <img
                  className="rounded shadow-lg"
